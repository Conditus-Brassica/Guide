...
const LoginScreen = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      const articlesStore = await AsyncStorage.getItem(articleRewardKey);
      AsyncStorage.removeItem(articleRewardKey);
      if (articlesStore != null)
        navigator.sendBeacon(
          BASE_URL + "/articles/interaction_finished",
          articlesStore
        );
      await AsyncStorage.setItem(storageUserEmailKey, form.email);
      await AsyncStorage.setItem(storageUserPasswordKey, form.password);
